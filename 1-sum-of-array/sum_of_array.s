...
#   X is the address locations of the first element

# 1(b) What is the address location of the last element (element 7) of the array, X.
#   Since the offset is 4, the address of the last element is X + 8

# 2.   What are the values at location 'SUM' as the program executes?
#   0, 0, 0, 0, 1 since SUM just gets the final value of the sum -2 -4 + 7 = 1   
...
#   Store the address of the current array element and increment it so it can reach the next value
#
#
